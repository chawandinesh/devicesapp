  ...
  static navigationOptions = {
   ...
   // headerShown: false,
    ...
    headerStyle: {
     ...
     // headerShown: false,
     // position: 'absolute', zIndex: 100, top: 0, left: 0, right: 0, elevation: 0, shadowOpacity: 0, borderBottomWidth: 0
      //Sets Header color
    },
...
arr:[],
  ...
  retrieveData = async () => {
    try {
      ...
      if (value !== null) {
       ...
       alert('Nothing Added yet. Please tap on "+" button to add new')
 ...
 async componentDidMount () {
  ...
  renderItem = ({item, index}) => {
    ...
    if (item.type == 'Friends'|| item.type == 'Family'){
      return (
